...
class AnswerProbabilityProvider:
    ...
    def get_answers_reputations(self, question_text: str, phrases: list[str], target_word: str) -> tuple[bool, dict[str, float]]:
        """
        ...
        for answer, original_reputation in reputation_probabilities.items():
            reputation = self.database_provider.lookup_answer_reputation(answer, target_word)
    ...
    def get_probability(self, question_text: str, target_word: str, phrases: list[str]) -> dict[str, float]:
        """
        ...
        any_reputation, answer_reputations = self.get_answers_reputations(question_text, phrases, target_word)
    ...
    def record_question_data(self, question_text: str, question_type: str, question_answer: str, question_possible_answers: list[str], target_word: str):
        ...
        self.database_provider.store_question_answer(question_answer.strip(), question_type, question_hash, True, target_word)
